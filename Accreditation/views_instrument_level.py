...
from Accreditation.forms import Create_InstrumentLevel_Form
from Accreditation.models import instrument, instrument_level
...
class InstrumentLevelList(PermissionRequiredMixin, View):
    ...
    def get(self, request, pk):
        ...
        context = { 'records': records, 'instrumentlevel_form': instrumentlevel_form, 'details': details, 'pk': pk}  #Getting all the data inside the type table and storing it to the context variable
    ...
    def post(self, request, pk):
        ...
        try:
            ...
            if instrumentlevel_form.is_valid():
                ...
                return JsonResponse({'instrumentlevel_errors': instrumentlevel_form.errors}, status=400)
